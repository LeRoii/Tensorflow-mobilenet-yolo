...
__C.TRAIN.ANNOT_PATH = "/home/zpwang/code/TensorFlow-yolov3-tiny/data/dataset/voc_train.txt"
...
__C.TRAIN.INITIAL_WEIGHT = "/home/zpwang/code/TensorFlow-yolov3-tiny/checkpoint/mobilenet/yoalov3_mn416test_loss=m10.5303.ckpt-49"

# TEST options
__C.TEST = edict()

__C.TEST.ANNOT_PATH = "/home/zpwang/code/TensorFlow-yolov3-tiny/data/dataset/voc_test.txt"
...
__C.TEST.WEIGHT_FILE = "/home/zpwang/code/TensorFlow-yolov3-tiny/checkpoint/yolov3_mn384_test_loss=10.2160.ckpt-2"
